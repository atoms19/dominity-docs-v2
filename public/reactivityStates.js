...
export default function reactivityStates() {
   return div(
      ...
      p(
         "states are reactive values that are powered by signals , just like useState in react but theres a big difference they arent tied to their component they can be anywhere you can export these states between components , youll never have to worry about prop drilling to get a state through , they are very efficient and fast as they are build on top of  ",
         a({ href: "https://github.com/preactjs/signals" }, "preact signals")
      ),
      codeBlock(`
