...
export default function creatingElements() {
  ...
  button('click me').on('click',()=>alert('clicked')).on('keydown',()=>alert('pressed'))
      ...
      p(
         "dominity has a method called .css() which allows you to directy add css to an element from js itself"
      ),
      codeBlock(`
button("click me").css({
    ...
    border:'none'
      ...
      note(
         "however pseudo classes and other things like :hover :after ,@media arent suppourted might be done in the future also its better to move css to a seperate file or use smthn like tailwind or synxia "
      ),
